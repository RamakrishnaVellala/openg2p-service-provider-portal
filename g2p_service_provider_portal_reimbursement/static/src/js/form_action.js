...
fetch("/portal/serviceprovider/reimbursement/get_voucher_codes")
...
function reimbursementFormSubmitAction() {
    ...
    programForm[0].action = `/portal/serviceprovider/reimbursement/submit/${program_id[0].getAttribute(
        "program"
    )}`;
